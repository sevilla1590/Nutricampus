    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <x-input type="password"
                        class="mt-1 block w-3/4 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500"
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3 bg-red-500 hover:bg-red-600 text-white" wire:click="logoutOtherBrowserSessions"
